...
import PortfolioDocumentUploader from './uploaders/DocumentUploader ';


export default function PortfolioDocument(props) {
    ...
    return (
        <div>
            <button onClick={() => { handleOpen() }} class="btn btn-dark text-white addproject-field-height-button float-right NextButton">NEXT</button>
                    ...
                    <div className='container_add_content_middle'>
                        <div className='row'>
                            <div className='addproject_navigation'>
                                ...
                                <p className='number-box'><span className='circle-around-number circle-around-number_two_padding circle-active'>2</span><span className="circle-name circle-active">Introduction Video</span></p>
                        ...
                        <div className='row'>
                            <div className='col-12 addproject-upload-image-area padding-left-right-zero'>
                                <div className='thumbnail'>Add Your File</div>
                                <PortfolioDocumentUploader />
                    ...
                    <div className='container_add_content_bottom'>
                        <div className='row'>
                            <div class="col-12 pr-0">
                                <button class="btn btn-dark text-white addproject-field-height-button float-right">NEXT</button>
