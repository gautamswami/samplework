...
export default function ThesisDocument(props) {
                    ...
                    <div className='container_add_content_middle'>
                        <div className='row'>
                            <div className='addproject_navigation'>
                                ...
                                <p className='number-box'><span className='circle-around-number circle-around-number_two_padding'>2</span><span className="circle-name">Document</span></p>
                            </div>
                        </div>
                        <div className='row'>
