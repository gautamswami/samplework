  ...
  return (
    <div>
        <div style={{display:'flex',flexDirection:'row',justifyContent:'space-between',marginBottom:"30px"}}>
            <div style={{display:"flex",flexDirection:"column",color:"#1F1F1F",fontSize:"18px",fontWeight:"700"}}><div>Degree, Specialization</div>
            {/* <div style={{fontSize:"14px",color:"#1F1F1F",fontWeight:"500"}}>Employment Type </div> */}
            <div style={{fontSize:"14px",color:"#1F1F1F",fontWeight:"500"}}>School, MM/YYYY-MM/YYYY</div>
